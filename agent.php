...
<body>
    ...
    <!-- Button with Href -->
    <a href="addagent1.php" class="button">ADD</a>
       <a href="agentview1.php" class="button">VIEW</a>
          <a href="editagent1.php" class="button">EDIT</a>
...
if ($result = $mysqli->query("SELECT * FROM agents")) {
