...
<body>
 ...
 <!-- Search Form -->
 <!-- Search Form -->
        <form action="editorder2.php" method="post">
            <div class="centered-content">
                <label for="search-AGENT_CODE">Enter Code to ORDER :</label>
                <input type="text" class="form-control" id="ORD_NUM" name="ORD_NUM"> <br></br>
