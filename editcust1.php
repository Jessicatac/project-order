...
<body>
 ...
 <!-- Search Form -->
        <form action="editcust2.php" method="post">
            <div class="centered-content">
                <label for="search-id">Enter Code to CUSTOMER :</label>
                <input type="text" class="form-control" id="CUST_CODE" name="CUST_CODE"> <br></br>
